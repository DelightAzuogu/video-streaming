...
router.get("/search/categories", videoController.getSearchVideosByCategories);
...
router.get("/my-videos", userAuth, videoController.getUserVideos);
...
router.post("/guest/view/:videoId", videoController.postGuestAddView);

router.get("/get/user/viewed", userAuth, videoController.getUserViewedVideos);

router.post("/delete/:videoId", userAuth, videoController.postDeleteVideo);
